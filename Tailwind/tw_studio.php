...
<header>
    <div class="absolute left-0 right-0 top-2 z-40 pt-14">
        <div class="mx-auto max-w-7xl px-6 lg:px-8">
            <div class="mx-auto max-w-2xl lg:max-w-none">
                <div class="flex items-center justify-between"><a aria-label="Home" href="/">
                        <svg viewBox="0 0 32 32" aria-hidden="true" class="h-8 sm:hidden">
                            <rect clip-path="url(#:R1ata:-clip)"
                                  class="h-8 transition-all duration-300 fill-neutral-950 w-0 group-hover/logo:w-8"></rect>
                            <use href="#:R1ata:-path" class="stroke-neutral-950" fill="none" stroke-width="1.5"></use>
                            <defs>
                                <path id=":R1ata:-path"
                        ...
                        <svg viewBox="0 0 130 32" aria-hidden="true" class="hidden h-8 sm:block">
                            <svg viewBox="0 0 32 32" aria-hidden="true" preserveAspectRatio="xMinYMid meet">
                                <rect clip-path="url(#:R6ata:-clip)"
                                      class="h-8 transition-all duration-300 fill-neutral-950 w-0 group-hover/logo:w-8"></rect>
                                <use href="#:R6ata:-path" class="stroke-neutral-950" fill="none"
                    ...
                    <div class="flex items-center gap-x-8"><a
                        ...
                        <button type="button" aria-expanded="false" aria-controls=":R5a:"
    ...
    <div id=":R5a:" style="height: 0.5rem; transform: none; transform-origin: 50% 50% 0px;"
         class="relative z-50 overflow-hidden bg-neutral-950 pt-2" aria-hidden="true" inert="">
            ...
            <div class="bg-neutral-950 pb-16 pt-14">
                <div class="mx-auto max-w-7xl px-6 lg:px-8">
                    <div class="mx-auto max-w-2xl lg:max-w-none">
                        <div class="flex items-center justify-between"><a aria-label="Home" href="/">
                                <svg viewBox="0 0 32 32" aria-hidden="true" class="h-8 sm:hidden">
                                    <rect clip-path="url(#:R2mkta:-clip)"
                                          class="h-8 transition-all duration-300 fill-white w-0 group-hover/logo:w-8"></rect>
                                    <use href="#:R2mkta:-path" class="stroke-white" fill="none"
                                         stroke-width="1.5"></use>
                                    <defs>
                                        <path id=":R2mkta:-path"
                                              d="M3.25 26v.75H7c1.305 0 2.384-.21 3.346-.627.96-.415 1.763-1.02 2.536-1.752.695-.657 1.39-1.443 2.152-2.306l.233-.263c.864-.975 1.843-2.068 3.071-3.266 1.209-1.18 2.881-1.786 4.621-1.786h5.791V5.25H25c-1.305 0-2.384.21-3.346.627-.96.415-1.763 1.02-2.536 1.751-.695.658-1.39 1.444-2.152 2.307l-.233.263c-.864.975-1.843 2.068-3.071 3.266-1.209 1.18-2.881 1.786-4.621 1.786H3.25V26Z"></path>
                                ...
                                <svg viewBox="0 0 130 32" aria-hidden="true" class="hidden h-8 sm:block">
                                    <svg viewBox="0 0 32 32" aria-hidden="true" preserveAspectRatio="xMinYMid meet">
                                        <rect clip-path="url(#:Rcmkta:-clip)"
                                              class="h-8 transition-all duration-300 fill-white w-0 group-hover/logo:w-8"></rect>
                                        <use href="#:Rcmkta:-path" class="stroke-white" fill="none"
                                             stroke-width="1.5"></use>
                                        <defs>
                                            <path id=":Rcmkta:-path"
                                                  d="M3.25 26v.75H7c1.305 0 2.384-.21 3.346-.627.96-.415 1.763-1.02 2.536-1.752.695-.657 1.39-1.443 2.152-2.306l.233-.263c.864-.975 1.843-2.068 3.071-3.266 1.209-1.18 2.881-1.786 4.621-1.786h5.791V5.25H25c-1.305 0-2.384.21-3.346.627-.96.415-1.763 1.02-2.536 1.751-.695.658-1.39 1.444-2.152 2.307l-.233.263c-.864.975-1.843 2.068-3.071 3.266-1.209 1.18-2.881 1.786-4.621 1.786H3.25V26Z"></path>
                ...
                <div class="mx-auto max-w-7xl px-6 lg:px-8">
                    <div class="mx-auto max-w-2xl lg:max-w-none">
                        <div class="grid grid-cols-1 gap-y-10 pb-16 pt-10 sm:grid-cols-2 sm:pt-16">
                            <div><h2 class="font-display text-base font-semibold text-white">Our offices</h2>
                                <ul role="list" class="mt-6 grid grid-cols-1 gap-8 sm:grid-cols-2">
                                    <li>
                                        <address class="text-sm not-italic text-neutral-300"><strong class="text-white">Copenhagen</strong><br>1
                            ...
                            <div class="sm:border-l sm:border-transparent sm:pl-16"><h2
                                ...
                                <ul role="list" class="flex gap-x-10 text-white mt-6">
                                    <li><a aria-label="Facebook" class="transition hover:text-neutral-200"
                                    ...
                                    <li><a aria-label="Twitter" class="transition hover:text-neutral-200"
                                    ...
                                    <li><a aria-label="GitHub" class="transition hover:text-neutral-200"
                                    ...
                                    <li><a aria-label="Dribbble" class="transition hover:text-neutral-200"
...
<div style="border-top-left-radius: 40px; border-top-right-radius: 40px; transform: none; transform-origin: 50% 50% 0px;"
     class="relative flex flex-auto overflow-hidden bg-white pt-14">
    <div class="relative isolate flex w-full flex-col pt-9" style="transform: none; transform-origin: 50% 50% 0px;">
        <svg aria-hidden="true"
            ...
            <defs>
                <pattern id=":R1lda:" width="96" height="480" x="50%" patternUnits="userSpaceOnUse"
        ...
        <main class="w-full flex-auto">
            <div class="mx-auto max-w-7xl px-6 lg:px-8 mt-24 sm:mt-32 md:mt-56">
                <div class="mx-auto max-w-2xl lg:max-w-none">
                    <div class="max-w-3xl" style="opacity: 1; transform: none;"><h1
                        ...
                        <p class="mt-6 text-xl text-neutral-600">We are a development studio working at the intersection
                            of design and technology. It’s a really busy intersection though — a lot of our staff have
                            been involved in hit and runs.</p></div>
                </div>
            </div>
                    ...
                    <div class="mx-auto max-w-2xl lg:max-w-none">
                        ...
                        <div>
                            <ul role="list" class="mt-10 grid grid-cols-2 gap-x-8 gap-y-10 lg:grid-cols-4">
                                ...
                                <li>
                                    <div style="opacity: 1; transform: none;"><img alt="North Adventures" loading="lazy"
                                                                                   width="184" height="36"
                                                                                   decoding="async" data-nimg="1"
                                                                                   style="color:transparent"
            ...
            <div class="mx-auto max-w-7xl px-6 lg:px-8 mt-24 sm:mt-32 lg:mt-40">
                <div class="mx-auto max-w-2xl lg:max-w-none">
                    <div class="max-w-2xl" style="opacity: 1; transform: none;"><h2><span
                        ...
                        <div class="mt-6 text-xl text-neutral-600"><p>We believe technology is the answer to the world’s
                                greatest challenges. It’s also the cause, so we find ourselves in bit of a catch 22
                                situation.</p></div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
                        <div class="flex" style="opacity: 1; transform: none;">
                            <article
                                ...
                                <h3><a href="/work/family-fund"><span class="absolute inset-0 rounded-3xl"></span><img
                                                alt="FamilyFund" loading="lazy" width="36" height="36" decoding="async"
                                                data-nimg="1" class="h-16 w-16" style="color:transparent"
                                                src="/_next/static/media/logomark-dark.4d2947be.svg"></a></h3>
                                <p class="mt-6 flex gap-x-2 text-sm text-neutral-950">
                                    <time datetime="2023" class="font-semibold">2023</time>
                                    <span class="text-neutral-300" aria-hidden="true">/</span><span>Case study</span>
                                </p>
                                ...
                                <p class="mt-4 text-base text-neutral-600">FamilyFund is a crowdfunding platform for
                                    friends and family. Allowing users to take personal loans from their network without
                                    a traditional financial institution.</p></article>
                        </div>
                        <div class="flex" style="opacity: 1; transform: none;">
                            <article
                                    class="relative flex w-full flex-col rounded-3xl p-6 ring-1 ring-neutral-950/5 transition hover:bg-neutral-50 sm:p-8">
                                <h3><a href="/work/unseal"><span class="absolute inset-0 rounded-3xl"></span><img
                                                ...
                                                data-nimg="1" class="h-16 w-16" style="color:transparent"
                                                src="/_next/static/media/logomark-dark.73187f97.svg"></a></h3>
                                <p class="mt-6 flex gap-x-2 text-sm text-neutral-950">
                                    <time datetime="2022" class="font-semibold">2022</time>
                                    <span class="text-neutral-300" aria-hidden="true">/</span><span>Case study</span>
                                </p>
                                <p class="mt-6 font-display text-2xl font-semibold text-neutral-950">Get a hodl of your
                                    health</p>
                                <p class="mt-4 text-base text-neutral-600">Unseal is the first NFT platform where users
                                    can mint and trade NFTs of their own personal health records, allowing them to take
                                    control of their data.</p></article>
                        </div>
                        <div class="flex" style="opacity: 1; transform: none;">
                            <article
                                    class="relative flex w-full flex-col rounded-3xl p-6 ring-1 ring-neutral-950/5 transition hover:bg-neutral-50 sm:p-8">
                                <h3><a href="/work/phobia"><span class="absolute inset-0 rounded-3xl"></span><img
                                                ...
                                                data-nimg="1" class="h-16 w-16" style="color:transparent"
                                                src="/_next/static/media/logomark-dark.00d7d7b3.svg"></a></h3>
                                <p class="mt-6 flex gap-x-2 text-sm text-neutral-950">
                                    <time datetime="2022" class="font-semibold">2022</time>
                                    <span class="text-neutral-300" aria-hidden="true">/</span><span>Case study</span>
                                </p>
                                ...
                                <p class="mt-4 text-base text-neutral-600">Find love in the face of fear — Phobia is a
                                    dating app that matches users based on their mutual phobias so they can be scared
                                    together.</p></article>
                        </div>
                    </div>
                </div>
            ...
            <div class="relative isolate bg-neutral-50 py-16 sm:py-28 md:py-32 mt-24 sm:mt-32 lg:mt-40">
                <svg aria-hidden="true"
                    ...
                    <rect width="100%" height="100%" fill="url(#:R6aqlda:)" stroke-width="0"></rect>
                    ...
                    <defs>
                        <pattern id=":R6aqlda:" width="96" height="480" x="50%" patternUnits="userSpaceOnUse"
                            ...
                            <figure class="mx-auto max-w-4xl">
                                <blockquote
                                    ...
                                    <p class="before:content-['“'] after:content-['”'] sm:before:absolute sm:before:right-full">
                                        ...
                                        to access the user’s microphone without triggering one of those annoying
                                        permission dialogs.</p></blockquote>
            ...
            <div class="mx-auto max-w-7xl px-6 lg:px-8 mt-24 sm:mt-32 lg:mt-40">
                <div class="mx-auto max-w-2xl lg:max-w-none">
                    <div class="max-w-2xl" style="opacity: 1; transform: none;"><h2><span
                                    ...
                                    class="block font-display tracking-tight [text-wrap:balance] text-4xl font-medium sm:text-5xl text-neutral-950">We help you identify, explore and respond to new opportunities.</span>
                        </h2>
                        <div class="mt-6 text-xl text-neutral-600"><p>As long as those opportunities involve giving us
                                money to re-purpose old projects — we can come up with an endless number of those.</p>
                        </div>
                    </div>
                </div>
            </div>
                                        ...
                                        <g clip-path="url(#:S1:-clip)" class="group">
                                            <g class="origin-center scale-100 transition duration-500 motion-safe:group-hover:scale-105">
                                                <foreignObject width="655" height="680"><img alt="" loading="lazy"
                                                                                             ...
                                                                                             srcset="/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Flaptop.22dcb094.jpg&amp;w=16&amp;q=75 16w,
                                                                                             /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Flaptop.22dcb094.jpg&amp;w=32&amp;q=75 32w,
                                                                                             /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Flaptop.22dcb094.jpg&amp;w=48&amp;q=75 48w,
                                                                                             /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Flaptop.22dcb094.jpg&amp;w=64&amp;q=75 64w,
                                                                                             /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Flaptop.22dcb094.jpg&amp;w=96&amp;q=75 96w,
                                                                                             /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Flaptop.22dcb094.jpg&amp;w=128&amp;q=75 128w,
                                                                                             /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Flaptop.22dcb094.jpg&amp;w=256&amp;q=75 256w,
                                                                                             /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Flaptop.22dcb094.jpg&amp;w=384&amp;q=75 384w,
                                                                                             /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Flaptop.22dcb094.jpg&amp;w=640&amp;q=75 640w,
                                                                                             https://studio.tailwindui.com/_next/image?url=%2F_next%2Fstatic%2Fmedia%2Flaptop.22dcb094.jpg&w=750&q=75 750w,
                                                                                             /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Flaptop.22dcb094.jpg&amp;w=828&amp;q=75 828w,
                                                                                             /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Flaptop.22dcb094.jpg&amp;w=1080&amp;q=75 1080w,
                                                                                             /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Flaptop.22dcb094.jpg&amp;w=1200&amp;q=75 1200w,
                                                                                             /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Flaptop.22dcb094.jpg&amp;w=1920&amp;q=75 1920w,
                                                                                             /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Flaptop.22dcb094.jpg&amp;w=2048&amp;q=75 2048w,
                                                                                             /_next/image?url=%2F_next%2Fstatic%2Fmedia%2Flaptop.22dcb094.jpg&amp;w=3840&amp;q=75 3840w"
                                            ...
                                            <use href="#:S1:-shape" stroke-width="2"
                                                 class="stroke-neutral-950/10"></use>
                                        </g>
                                        <defs>
                                            <clipPath id=":S1:-clip">
                                                <path id=":S1:-shape"
                        ...
                        <div>
                            <ul role="list"
                                ...
                                <li class="group mt-10 first:mt-0">
                                    <div style="opacity: 1; transform: none;">
                                        <div class="pt-10 group-first:pt-0 group-first:before:hidden group-first:after:hidden relative before:absolute after:absolute before:bg-neutral-950 after:bg-neutral-950/10 before:left-0 before:top-0 before:h-px before:w-6 after:left-8 after:right-0 after:top-0 after:h-px">
                                            ...
                                            specialise in crafting beautiful, high quality marketing pages. The rest of
                                ...
                                <li class="group mt-10 first:mt-0">
                                    <div style="opacity: 1; transform: none;">
                                        <div class="pt-10 group-first:pt-0 group-first:before:hidden group-first:after:hidden relative before:absolute after:absolute before:bg-neutral-950 after:bg-neutral-950/10 before:left-0 before:top-0 before:h-px before:w-6 after:left-8 after:right-0 after:top-0 after:h-px">
                                            <strong class="font-semibold text-neutral-950">Application
                                                development. </strong>We have a team of skilled developers who are
                                            experts in the latest app frameworks, like Angular 1 and Google Web Toolkit.
                                        </div>
                                    </div>
                                </li>
                                <li class="group mt-10 first:mt-0">
                                    <div style="opacity: 1; transform: none;">
                                        <div class="pt-10 group-first:pt-0 group-first:before:hidden group-first:after:hidden relative before:absolute after:absolute before:bg-neutral-950 after:bg-neutral-950/10 before:left-0 before:top-0 before:h-px before:w-6 after:left-8 after:right-0 after:top-0 after:h-px">
                                            <strong class="font-semibold text-neutral-950">E-commerce. </strong>We are
                                            at the forefront of modern e-commerce development. Which mainly means adding
                                    ...
                                    <div style="opacity: 1; transform: none;">
                                        <div class="pt-10 group-first:pt-0 group-first:before:hidden group-first:after:hidden relative before:absolute after:absolute before:bg-neutral-950 after:bg-neutral-950/10 before:left-0 before:top-0 before:h-px before:w-6 after:left-8 after:right-0 after:top-0 after:h-px">
                                            <strong class="font-semibold text-neutral-950">Custom content
                                                management. </strong>At Studio we understand the importance of having a
                                            robust and customised CMS. That’s why we run all of our client projects out
                    ...
                    <div class="-mx-6 rounded-4xl bg-neutral-950 px-6 py-20 sm:mx-0 sm:py-32 md:px-12"
                        ...
                        <div class="mx-auto max-w-4xl">
                            <div class="max-w-xl"><h2
                                        class="font-display text-3xl font-medium text-white [text-wrap:balance] sm:text-4xl">
                                    ...
                                    <ul role="list" class="mt-6 grid grid-cols-1 gap-8 sm:grid-cols-2">
                                        <li>
                                            <address class="text-sm not-italic text-neutral-300"><strong
                                                        class="text-white">Copenhagen</strong><br>1 Carlsberg Gate<br>1260,
                                                København, Denmark
                                            </address>
                                        </li>
                                        <li>
                ...
                <div style="opacity: 1; transform: none;">
                    <div class="grid grid-cols-1 gap-x-8 gap-y-16 lg:grid-cols-2">
                            ...
                            <ul role="list" class="grid grid-cols-2 gap-8 sm:grid-cols-3">
                                <li>
                                    ...
                                    <ul role="list" class="mt-4 text-sm text-neutral-700">
                                        ...
                                        <li class="mt-4"><a class="transition hover:text-neutral-950" href="/work">See
                                                all <span aria-hidden="true">→</span></a></li>
                                    </ul>
                                </li>
                                <li>
                                    <div class="font-display text-sm font-semibold tracking-wider text-neutral-950">
                                    ...
                                    <ul role="list" class="mt-4 text-sm text-neutral-700">
                                        ...
                                        <li class="mt-4"><a class="transition hover:text-neutral-950" href="/process">Process</a>
                                        </li>
                                        <li class="mt-4"><a class="transition hover:text-neutral-950"
                                                            href="/blog">Blog</a></li>
                        ...
                        <div class="flex lg:justify-end">
                            <form class="max-w-sm"><h2
                                        class="font-display text-sm font-semibold tracking-wider text-neutral-950">Sign
                    ...
                    <div class="mb-20 mt-24 flex flex-wrap items-end justify-between gap-x-6 gap-y-4 border-t border-neutral-950/10 pt-12">
                        <a aria-label="Home" href="/">
                            <svg viewBox="0 0 130 32" aria-hidden="true" class="group/logo h-8">
                                <svg viewBox="0 0 32 32" aria-hidden="true" preserveAspectRatio="xMinYMid meet">
                                    <rect clip-path="url(#:Rbblda:-clip)"
                                          class="h-8 transition-all duration-300 fill-neutral-950 w-0 group-hover/logo:w-8"></rect>
                                    <use href="#:Rbblda:-path" class="stroke-neutral-950" fill="none"
                                         stroke-width="1.5"></use>
                                    <defs>
                                        <path id=":Rbblda:-path"
                                              d="M3.25 26v.75H7c1.305 0 2.384-.21 3.346-.627.96-.415 1.763-1.02 2.536-1.752.695-.657 1.39-1.443 2.152-2.306l.233-.263c.864-.975 1.843-2.068 3.071-3.266 1.209-1.18 2.881-1.786 4.621-1.786h5.791V5.25H25c-1.305 0-2.384.21-3.346.627-.96.415-1.763 1.02-2.536 1.751-.695.658-1.39 1.444-2.152 2.307l-.233.263c-.864.975-1.843 2.068-3.071 3.266-1.209 1.18-2.881 1.786-4.621 1.786H3.25V26Z"></path>
                        ...
                        <p class="text-sm text-neutral-700">© Studio Agency Inc. <!-- -->2023</p></div>
                </div>
            </div>
        </footer>
    </div>
</div>
<script src="/_next/static/chunks/webpack-98ff8035a0b3efa8.js" async=""></script>
<script>(self.__next_f = self.__next_f || []).push([0])</script>
<script>self.__next_f.push([1, "1:HL[\"/_next/static/css/42b4b20aa244ad1f.css\",{\"as\":\"style\"}]\n0:\"$L2\"\n"])</script>
<script>self.__next_f.push([1, "3:I{\"id\":7948,\"chunks\":[\"272:static/chunks/webpack-98ff8035a0b3efa8.js\",\"971:static/chunks/fd9d1056-f0d7a6ac6a3812d6.js\",\"596:static/chunks/596-9cc258e70a1354c4.js\"],\"name\":\"default\",\"async\":false}\n5:I{\"id\":6628,\"chunks\":[\"272:static/chunks/webpack-98ff8035a0b3efa8.js\",\"971:static/chunks/fd9d1056-f0d7a6ac6a3812d6.js\",\"596:static/chunks/596-9cc258e70a1354c4.js\"],\"name\":\"\",\"async\":false}\n6:I{\"id\":8960,\"chunks\":[\"552:static/chunks/552-8362a7a9c2379e59.js\",\"185:static/chunks/app/layout-d977eb6538cd949b.js\"],\"na"])</script>
<script>self.__next_f.push([1, "me\":\"RootLayout\",\"async\":false}\n7:I{\"id\":7767,\"chunks\":[\"272:static/chunks/webpack-98ff8035a0b3efa8.js\",\"971:static/chunks/fd9d1056-f0d7a6ac6a3812d6.js\",\"596:static/chunks/596-9cc258e70a1354c4.js\"],\"name\":\"default\",\"async\":false}\n8:I{\"id\":7920,\"chunks\":[\"272:static/chunks/webpack-98ff8035a0b3efa8.js\",\"971:static/chunks/fd9d1056-f0d7a6ac6a3812d6.js\",\"596:static/chunks/596-9cc258e70a1354c4.js\"],\"name\":\"default\",\"async\":false}\n9:I{\"id\":7964,\"chunks\":[\"552:static/chunks/552-8362a7a9c2379e59.js\",\"222:static/chun"])</script>
<script>self.__next_f.push([1, "ks/222-6fb6c14b6cbe6ee5.js\",\"424:static/chunks/424-6f250d076e12cd57.js\",\"555:static/chunks/555-f3931447fd749a14.js\",\"931:static/chunks/app/page-1f2c3d89859b847c.js\"],\"name\":\"FadeIn\",\"async\":false}\na:I{\"id\":6685,\"chunks\":[\"552:static/chunks/552-8362a7a9c2379e59.js\",\"222:static/chunks/222-6fb6c14b6cbe6ee5.js\",\"424:static/chunks/424-6f250d076e12cd57.js\",\"555:static/chunks/555-f3931447fd749a14.js\",\"931:static/chunks/app/page-1f2c3d89859b847c.js\"],\"name\":\"\",\"async\":false}\n"])</script>
<script>self.__next_f.push([1, "2:[[[\"$\",\"link\",\"0\",{\"rel\":\"stylesheet\",\"href\":\"/_next/static/css/42b4b20aa244ad1f.css\",\"precedence\":\"next\"}]],[\"$\",\"$L3\",null,{\"buildId\":\"9BvIQZPrV2XPZ8zFHGCTt\",\"assetPrefix\":\"\",\"initialCanonicalUrl\":\"/\",\"initialTree\":[\"\",{\"children\":[\"__PAGE__\",{}]},\"$undefined\",\"$undefined\",true],\"initialHead\":\"$L4\",\"globalErrorComponent\":\"$5\",\"children\":[null,[\"$\",\"html\",null,{\"lang\":\"en\",\"className\":\"h-full bg-neutral-950 text-base antialiased\",\"children\":[\"$\",\"body\",null,{\"className\":\"flex min-h-full flex-col\",\"children\":[\"$\",\"$L6\",null,{\"children\":[\"$\",\"$L7\",null,{\"parallelRouterKey\":\"children\",\"segmentPath\":[\"children\"],\"error\":\"$undefined\",\"errorStyles\":\"$undefined\",\"loading\":\"$undefined\",\"loadingStyles\":\"$undefined\",\"hasLoading\":false,\"template\":[\"$\",\"$L8\",null,{}],\"templateStyles\":\"$undefined\",\"notFound\":[\"$\",\"div\",null,{\"className\":\"mx-auto max-w-7xl px-6 lg:px-8 flex h-full items-center pt-24 sm:pt-32 lg:pt-40\",\"children\":[\"$\",\"div\",null,{\"className\":\"mx-auto max-w-2xl lg:max-w-none\",\"children\":[\"$\",\"$L9\",null,{\"className\":\"flex max-w-xl flex-col items-center text-center\",\"children\":[[\"$\",\"p\",null,{\"className\":\"font-display text-4xl font-semibold text-neutral-950 sm:text-5xl\",\"children\":\"404\"}],[\"$\",\"h1\",null,{\"className\":\"mt-4 font-display text-2xl font-semibold text-neutral-950\",\"children\":\"Page not found\"}],[\"$\",\"p\",null,{\"className\":\"mt-2 text-sm text-neutral-600\",\"children\":\"Sorry, we couldn’t find the page you’re looking for.\"}],[\"$\",\"$La\",null,{\"href\":\"/\",\"className\":\"mt-4 text-sm font-semibold text-neutral-950 transition hover:text-neutral-700\",\"children\":\"Go to the home page\"}]]}]}]}],\"notFoundStyles\":[],\"childProp\":{\"current\":[\"$Lb\",\"$Lc\",null],\"segment\":\"__PAGE__\"},\"styles\":[]}]}]}]}],null]}]]\n"])</script>
<script>self.__next_f.push([1, "d:I{\"id\":7964,\"chunks\":[\"552:static/chunks/552-8362a7a9c2379e59.js\",\"222:static/chunks/222-6fb6c14b6cbe6ee5.js\",\"424:static/chunks/424-6f250d076e12cd57.js\",\"555:static/chunks/555-f3931447fd749a14.js\",\"931:static/chunks/app/page-1f2c3d89859b847c.js\"],\"name\":\"FadeInStagger\",\"async\":false}\ne:I{\"id\":3222,\"chunks\":[\"552:static/chunks/552-8362a7a9c2379e59.js\",\"222:static/chunks/222-6fb6c14b6cbe6ee5.js\",\"424:static/chunks/424-6f250d076e12cd57.js\",\"555:static/chunks/555-f3931447fd749a14.js\",\"931:static/chunks/app/p"])</script>
<script>self.__next_f.push([1, "age-1f2c3d89859b847c.js\"],\"name\":\"Image\",\"async\":false}\nf:I{\"id\":5399,\"chunks\":[\"552:static/chunks/552-8362a7a9c2379e59.js\",\"222:static/chunks/222-6fb6c14b6cbe6ee5.js\",\"424:static/chunks/424-6f250d076e12cd57.js\",\"555:static/chunks/555-f3931447fd749a14.js\",\"931:static/chunks/app/page-1f2c3d89859b847c.js\"],\"name\":\"GridPattern\",\"async\":false}\n4:[[\"$\",\"meta\",\"0\",{\"charSet\":\"utf-8\"}],[\"$\",\"title\",\"1\",{\"children\":\"Studio - Award winning developer studio based in Denmark\"}],[\"$\",\"meta\",\"2\",{\"name\":\"description\",\"c"])</script>
<script>self.__next_f.push([1, "ontent\":\"We are a development studio working at the intersection of design and technology.\"}],[\"$\",\"meta\",\"3\",{\"name\":\"viewport\",\"content\":\"width=device-width, initial-scale=1\"}],[\"$\",\"link\",\"4\",{\"rel\":\"icon\",\"href\":\"/favicon.ico\",\"type\":\"image/x-icon\",\"sizes\":\"16x16\"}]]\nb:null\n"])</script>
<script>self.__next_f.push([1, "c:[[\"$\",\"div\",null,{\"className\":\"mx-auto max-w-7xl px-6 lg:px-8 mt-24 sm:mt-32 md:mt-56\",\"children\":[\"$\",\"div\",null,{\"className\":\"mx-auto max-w-2xl lg:max-w-none\",\"children\":[\"$\",\"$L9\",null,{\"className\":\"max-w-3xl\",\"children\":[[\"$\",\"h1\",null,{\"className\":\"font-display text-5xl font-medium tracking-tight text-neutral-950 [text-wrap:balance] sm:text-7xl\",\"children\":\"Award-winning development studio based in Denmark.\"}],[\"$\",\"p\",null,{\"className\":\"mt-6 text-xl text-neutral-600\",\"children\":\"We are a development studio working at the intersection of design and technology. It’s a really busy intersection though — a lot of our staff have been involved in hit and runs.\"}]]}]}]}],[\"$\",\"div\",null,{\"className\":\"mt-24 rounded-4xl bg-neutral-950 py-20 sm:mt-32 sm:py-32 lg:mt-56\",\"children\":[\"$\",\"div\",null,{\"className\":\"mx-auto max-w-7xl px-6 lg:px-8\",\"children\":[\"$\",\"div\",null,{\"className\":\"mx-auto max-w-2xl lg:max-w-none\",\"children\":[[\"$\",\"$L9\",null,{\"className\":\"flex items-center gap-x-8\",\"children\":[[\"$\",\"h2\",null,{\"className\":\"text-center font-display text-sm font-semibold tracking-wider text-white sm:text-left\",\"children\":\"We’ve worked with hundreds of amazing people\"}],[\"$\",\"div\",null,{\"className\":\"h-px flex-auto bg-neutral-800\"}]]}],[\"$\",\"$Ld\",null,{\"faster\":true,\"children\":[\"$\",\"ul\",null,{\"role\":\"list\",\"className\":\"mt-10 grid grid-cols-2 gap-x-8 gap-y-10 lg:grid-cols-4\",\"children\":[[\"$\",\"li\",\"Phobia\",{\"children\":[\"$\",\"$L9\",null,{\"children\":[\"$\",\"$Le\",null,{\"src\":{\"src\":\"/_next/static/media/logo-light.ada2d552.svg\",\"height\":36,\"width\":184,\"blurWidth\":0,\"blurHeight\":0},\"alt\":\"Phobia\",\"unoptimized\":true}]}]}],[\"$\",\"li\",\"Family Fund\",{\"children\":[\"$\",\"$L9\",null,{\"children\":[\"$\",\"$Le\",null,{\"src\":{\"src\":\"/_next/static/media/logo-light.5c8de99c.svg\",\"height\":36,\"width\":184,\"blurWidth\":0,\"blurHeight\":0},\"alt\":\"Family Fund\",\"unoptimized\":true}]}]}],[\"$\",\"li\",\"Unseal\",{\"children\":[\"$\",\"$L9\",null,{\"children\":[\"$\",\"$Le\",null,{\"src\":{\"src\":\"/_next/static/media/logo-light.f6ce2960.svg\",\"height\":36,\"width\":184,\"blurWidth\":0,\"blurHeight\":0},\"alt\":\"Unseal\",\"unoptimized\":true}]}]}],[\"$\",\"li\",\"Mail Smirk\",{\"children\":[\"$\",\"$L9\",null,{\"children\":[\"$\",\"$Le\",null,{\"src\":{\"src\":\"/_next/static/media/logo-light.249606f6.svg\",\"height\":36,\"width\":184,\"blurWidth\":0,\"blurHeight\":0},\"alt\":\"Mail Smirk\",\"unoptimized\":true}]}]}],[\"$\",\"li\",\"Home Work\",{\"children\":[\"$\",\"$L9\",null,{\"children\":[\"$\",\"$Le\",null,{\"src\":{\"src\":\"/_next/static/media/logo-light.da1195d8.svg\",\"height\":36,\"width\":184,\"blurWidth\":0,\"blurHeight\":0},\"alt\":\"Home Work\",\"unoptimized\":true}]}]}],[\"$\",\"li\",\"Green Life\",{\"children\":[\"$\",\"$L9\",null,{\"children\":[\"$\",\"$Le\",null,{\"src\":{\"src\":\"/_next/static/media/logo-light.1704e6d8.svg\",\"height\":36,\"width\":184,\"blurWidth\":0,\"blurHeight\":0},\"alt\":\"Green Life\",\"unoptimized\":true}]}]}],[\"$\",\"li\",\"Bright Path\",{\"children\":[\"$\",\"$L9\",null,{\"children\":[\"$\",\"$Le\",null,{\"src\":{\"src\":\"/_next/static/media/logo-light.456aa9d9.svg\",\"height\":36,\"width\":184,\"blurWidth\":0,\"blurHeight\":0},\"alt\":\"Bright Path\",\"unoptimized\":true}]}]}],[\"$\",\"li\",\"North Adventures\",{\"children\":[\"$\",\"$L9\",null,{\"children\":[\"$\",\"$Le\",null,{\"src\":{\"src\":\"/_next/static/media/logo-light.e19f9c9b.svg\",\"height\":36,\"width\":184,\"blurWidth\":0,\"blurHeight\":0},\"alt\":\"North Adventures\",\"unoptimized\":true}]}]}]]}]}]]}]}]}],[[\"$\",\"div\",null,{\"className\":\"mx-auto max-w-7xl px-6 lg:px-8 mt-24 sm:mt-32 lg:mt-40\",\"children\":[\"$\",\"div\",null,{\"className\":\"mx-auto max-w-2xl lg:max-w-none\",\"children\":[\"$\",\"$L9\",null,{\"className\":\"max-w-2xl\",\"children\":[[\"$\",\"h2\",null,{\"children\":[\"$undefined\",[\"$\",\"span\",null,{\"className\":\"block font-display tracking-tight [text-wrap:balance] text-4xl font-medium sm:text-5xl text-neutral-950\",\"children\":\"Harnessing technology for a brighter future\"}]]}],[\"$\",\"div\",null,{\"className\":\"mt-6 text-xl text-neutral-600\",\"children\":[\"$\",\"p\",null,{\"children\":\"We believe technology is the answer to the world’s greatest challenges. It’s also the cause, so we find ourselves in bit of a catch 22 situation.\"}]}]]}]}]}],[\"$\",\"div\",null,{\"className\":\"mx-auto max-w-7xl px-6 lg:px-8 mt-16\",\"children\":[\"$\",\"div\",null,{\"className\":\"mx-auto max-w-2xl lg:max-w-none\",\"children\":[\"$\",\"$Ld\",null,{\"className\":\"grid grid-cols-1 gap-8 lg:grid-cols-3\",\"children\":[[\"$\",\"$L9\",\"/work/family-fund\",{\"className\":\"flex\",\"children\":[\"$\",\"article\",null,{\"className\":\"relative flex w-full flex-col rounded-3xl p-6 ring-1 ring-neutral-950/5 transition hover:bg-neutral-50 sm:p-8\",\"children\":[[\"$\",\"h3\",null,{\"children\":[\"$\",\"$La\",null,{\"href\":\"/work/family-fund\",\"children\":[[\"$\",\"span\",null,{\"className\":\"absolute inset-0 rounded-3xl\"}],[\"$\",\"$Le\",null,{\"src\":{\"src\":\"/_next/static/media/logomark-dark.4d2947be.svg\",\"height\":36,\"width\":36,\"blurWidth\":0,\"blurHeight\":0},\"alt\":\"FamilyFund\",\"className\":\"h-16 w-16\",\"unoptimized\":true}]]}]}],[\"$\",\"p\",null,{\"className\":\"mt-6 flex gap-x-2 text-sm text-neutral-950\",\"children\":[[\"$\",\"time\",null,{\"dateTime\":\"2023\",\"className\":\"font-semibold\",\"children\":\"2023\"}],[\"$\",\"span\",null,{\"className\":\"text-neutral-300\",\"aria-hidden\":\"true\",\"children\":\"/\"}],[\"$\",\"span\",null,{\"children\":\"Case study\"}]]}],[\"$\",\"p\",null,{\"className\":\"mt-6 font-display text-2xl font-semibold text-neutral-950\",\"children\":\"Skip the bank, borrow from those you trust\"}],[\"$\",\"p\",null,{\"className\":\"mt-4 text-base text-neutral-600\",\"children\":\"FamilyFund is a crowdfunding platform for friends and family. Allowing users to take personal loans from their network without a traditional financial institution.\"}]]}]}],[\"$\",\"$L9\",\"/work/unseal\",{\"className\":\"flex\",\"children\":[\"$\",\"article\",null,{\"className\":\"relative flex w-full flex-col rounded-3xl p-6 ring-1 ring-neutral-950/5 transition hover:bg-neutral-50 sm:p-8\",\"children\":[[\"$\",\"h3\",null,{\"children\":[\"$\",\"$La\",null,{\"href\":\"/work/unseal\",\"children\":[[\"$\",\"span\",null,{\"className\":\"absolute inset-0 rounded-3xl\"}],[\"$\",\"$Le\",null,{\"src\":{\"src\":\"/_next/static/media/logomark-dark.73187f97.svg\",\"height\":36,\"width\":36,\"blurWidth\":0,\"blurHeight\":0},\"alt\":\"Unseal\",\"className\":\"h-16 w-16\",\"unoptimized\":true}]]}]}],[\"$\",\"p\",null,{\"className\":\"mt-6 flex gap-x-2 text-sm text-neutral-950\",\"children\":[[\"$\",\"time\",null,{\"dateTime\":\"2022\",\"className\":\"font-semibold\",\"children\":\"2022\"}],[\"$\",\"span\",null,{\"className\":\"text-neutral-300\",\"aria-hidden\":\"true\",\"children\":\"/\"}],[\"$\",\"span\",null,{\"children\":\"Case study\"}]]}],[\"$\",\"p\",null,{\"className\":\"mt-6 font-display text-2xl font-semibold text-neutral-950\",\"children\":\"Get a hodl of your health\"}],[\"$\",\"p\",null,{\"className\":\"mt-4 text-base text-neutral-600\",\"children\":\"Unseal is the first NFT platform where users can mint and trade NFTs of their own personal health records, allowing them to take control of their data.\"}]]}]}],[\"$\",\"$L9\",\"/work/phobia\",{\"className\":\"flex\",\"children\":[\"$\",\"article\",null,{\"className\":\"relative flex w-full flex-col rounded-3xl p-6 ring-1 ring-neutral-950/5 transition hover:bg-neutral-50 sm:p-8\",\"children\":[[\"$\",\"h3\",null,{\"children\":[\"$\",\"$La\",null,{\"href\":\"/work/phobia\",\"children\":[[\"$\",\"span\",null,{\"className\":\"absolute inset-0 rounded-3xl\"}],[\"$\",\"$Le\",null,{\"src\":{\"src\":\"/_next/static/media/logomark-dark.00d7d7b3.svg\",\"height\":36,\"width\":36,\"blurWidth\":0,\"blurHeight\":0},\"alt\":\"Phobia\",\"className\":\"h-16 w-16\",\"unoptimized\":true}]]}]}],[\"$\",\"p\",null,{\"className\":\"mt-6 flex gap-x-2 text-sm text-neutral-950\",\"children\":[[\"$\",\"time\",null,{\"dateTime\":\"2022\",\"className\":\"font-semibold\",\"children\":\"2022\"}],[\"$\",\"span\",null,{\"className\":\"text-neutral-300\",\"aria-hidden\":\"true\",\"children\":\"/\"}],[\"$\",\"span\",null,{\"children\":\"Case study\"}]]}],[\"$\",\"p\",null,{\"className\":\"mt-6 font-display text-2xl font-semibold text-neutral-950\",\"children\":\"Overcome your fears, find your match\"}],[\"$\",\"p\",null,{\"className\":\"mt-4 text-base text-neutral-600\",\"children\":\"Find love in the face of fear — Phobia is a dating app that matches users based on their mutual phobias so they can be scared together.\"}]]}]}]]}]}]}]],[\"$\",\"div\",null,{\"className\":\"relative isolate bg-neutral-50 py-16 sm:py-28 md:py-32 mt-24 sm:mt-32 lg:mt-40\",\"children\":[[\"$\",\"$Lf\",null,{\"className\":\"absolute inset-0 -z-10 h-full w-full fill-neutral-100 stroke-neutral-950/5 [mask-image:linear-gradient(to_bottom_left,white_50%,transparent_60%)]\",\"yOffset\":-256}],[\"$\",\"div\",null,{\"className\":\"mx-auto max-w-7xl px-6 lg:px-8\",\"children\":[\"$\",\"div\",null,{\"className\":\"mx-auto max-w-2xl lg:max-w-none\",\"children\":[\"$\",\"$L9\",null,{\"children\":[\"$\",\"figure\",null,{\"className\":\"mx-auto max-w-4xl\",\"children\":[[\"$\",\"blockquote\",null,{\"className\":\"relative font-display text-3xl font-medium tracking-tight text-neutral-950 sm:text-4xl\",\"children\":[\"$\",\"p\",null,{\"className\":\"before:content-['“'] after:content-['”'] sm:before:absolute sm:before:right-full\",\"children\":\"The team at Studio went above and beyond with our onboarding, even finding a way to access the user’s microphone without triggering one of those annoying permission dialogs.\"}]}],[\"$\",\"figcaption\",null,{\"className\":\"mt-10\",\"children\":[\"$\",\"$Le\",null,{\"src\":{\"src\":\"/_next/static/media/logo-dark.353d4760.svg\",\"height\":36,\"width\":184,\"blurWidth\":0,\"blurHeight\":0},\"alt\":\"Phobia\",\"unoptimized\":true}]}]]}]}]}]}]]}],[[\"$\",\"div\",null,{\"className\":\"mx-auto max-w-7xl px-6 lg:px-8 mt-24 sm:mt-32 lg:mt-40\",\"children\":[\"$\",\"div\",null,{\"className\":\"mx-auto max-w-2xl lg:max-w-none\",\"children\":[\"$\",\"$L9\",null,{\"className\":\"max-w-2xl\",\"children\":[[\"$\",\"h2\",null,{\"children\":[[[\"$\",\"span\",null,{\"className\":\"mb-6 block font-display text-base font-semibold text-neutral-950\",\"children\":\"Services\"}],[\"$\",\"span\",null,{\"className\":\"sr-only\",\"children\":\" - \"}]],[\"$\",\"span\",null,{\"className\":\"block font-display tracking-tight [text-wrap:balance] text-4xl font-medium sm:text-5xl text-neutral-950\",\"children\":\"We help you identify, explore and respond to new opportunities.\"}]]}],[\"$\",\"div\",null,{\"className\":\"mt-6 text-xl text-neutral-600\",\"children\":[\"$\",\"p\",null,{\"children\":\"As long as those opportunities involve giving us money to re-purpose old projects — we can come up with an endless number of those.\"}]}]]}]}]}],[\"$\",\"div\",null,{\"className\":\"mx-auto max-w-7xl px-6 lg:px-8 mt-16\",\"children\":[\"$\",\"div\",null,{\"className\":\"mx-auto max-w-2xl lg:max-w-none\",\"children\":[\"$\",\"div\",null,{\"className\":\"lg:flex lg:items-center lg:justify-end\",\"children\":[[\"$\",\"div\",null,{\"className\":\"flex justify-center lg:w-1/2 lg:justify-end lg:pr-12\",\"children\":[\"$\",\"$L9\",null,{\"className\":\"w-[33.75rem] flex-none lg:w-[45rem]\",\"children\":[\"$\",\"div\",null,{\"className\":\"justify-center lg:justify-end relative flex aspect-[719/680] w-full grayscale\",\"children\":[\"$\",\"svg\",null,{\"viewBox\":\"0 0 655 680\",\"fill\":\"none\",\"className\":\"h-full\",\"children\":[[\"$\",\"g\",null,{\"clipPath\":\"url(#:S1:-clip)\",\"className\":\"group\",\"children\":[[\"$\",\"g\",null,{\"className\":\"origin-center scale-100 transition duration-500 motion-safe:group-hover:scale-105\",\"children\":[\"$\",\"foreignObject\",null,{\"width\":655,\"height\":680,\"children\":[\"$\",\"$Le\",null,{\"alt\":\"\",\"className\":\"w-full bg-neutral-100 object-cover\",\"style\":{\"aspectRatio\":\"655 / 680\"},\"src\":{\"src\":\"/_next/static/media/laptop.22dcb094.jpg\",\"height\":3000,\"width\":2400,\"blurDataURL\":\"data:image/jpeg;base64,\",\"blurWidth\":6,\"blurHeight\":8},\"sizes\":\"(min-width: 1024px) 41rem, 31rem\"}]}]}],[\"$\",\"use\",null,{\"href\":\"#:S1:-shape\",\"strokeWidth\":\"2\",\"className\":\"stroke-neutral-950/10\"}]]}],[\"$\",\"defs\",null,{\"children\":[\"$\",\"clipPath\",null,{\"id\":\":S1:-clip\",\"children\":[\"$\",\"path\",null,{\"id\":\":S1:-shape\",\"d\":\"M537.827 9.245A11.5 11.5 0 0 1 549.104 0h63.366c7.257 0 12.7 6.64 11.277 13.755l-25.6 128A11.5 11.5 0 0 1 586.87 151h-28.275a15.999 15.999 0 0 0-15.689 12.862l-59.4 297c-1.98 9.901 5.592 19.138 15.689 19.138h17.275l.127.001c.85.009 1.701.074 2.549.009 11.329-.874 21.411-7.529 24.88-25.981.002-.012.016-.016.023-.007.008.009.022.005.024-.006l24.754-123.771A11.5 11.5 0 0 1 580.104 321h63.366c7.257 0 12.7 6.639 11.277 13.755l-25.6 128A11.5 11.5 0 0 1 617.87 472H559c-22.866 0-28.984 7.98-31.989 25.931-.004.026-.037.035-.052.014-.015-.02-.048-.013-.053.012l-24.759 123.798A11.5 11.5 0 0 1 490.87 631h-29.132a14.953 14.953 0 0 0-14.664 12.021c-4.3 21.502-23.18 36.979-45.107 36.979H83.502c-29.028 0-50.8-26.557-45.107-55.021l102.4-512C145.096 91.477 163.975 76 185.902 76h318.465c10.136 0 21.179-5.35 23.167-15.288l10.293-51.467Zm-512 160A11.5 11.5 0 0 1 37.104 160h63.366c7.257 0 12.7 6.639 11.277 13.755l-25.6 128A11.5 11.5 0 0 1 74.87 311H11.504c-7.257 0-12.7-6.639-11.277-13.755l25.6-128Z\",\"fillRule\":\"evenodd\",\"clipRule\":\"evenodd\"}]}]}]]}]}]}]}],[\"$\",\"$Ld\",null,{\"children\":[\"$\",\"ul\",null,{\"role\":\"list\",\"className\":\"text-base text-neutral-600 mt-16 lg:mt-0 lg:w-1/2 lg:min-w-[33rem] lg:pl-4\",\"children\":[[\"$\",\"li\",null,{\"className\":\"group mt-10 first:mt-0\",\"children\":[\"$\",\"$L9\",null,{\"children\":[\"$\",\"div\",null,{\"className\":\"pt-10 group-first:pt-0 group-first:before:hidden group-first:after:hidden relative before:absolute after:absolute before:bg-neutral-950 after:bg-neutral-950/10 before:left-0 before:top-0 before:h-px before:w-6 after:left-8 after:right-0 after:top-0 after:h-px\",\"children\":[[\"$\",\"strong\",null,{\"className\":\"font-semibold text-neutral-950\",\"children\":\"Web development. \"}],\"We specialise in crafting beautiful, high quality marketing pages. The rest of the website will be a shell that uses lorem ipsum everywhere.\"]}]}]}],[\"$\",\"li\",null,{\"className\":\"group mt-10 first:mt-0\",\"children\":[\"$\",\"$L9\",null,{\"children\":[\"$\",\"div\",null,{\"className\":\"pt-10 group-first:pt-0 group-first:before:hidden group-first:after:hidden relative before:absolute after:absolute before:bg-neutral-950 after:bg-neutral-950/10 before:left-0 before:top-0 before:h-px before:w-6 after:left-8 after:right-0 after:top-0 after:h-px\",\"children\":[[\"$\",\"strong\",null,{\"className\":\"font-semibold text-neutral-950\",\"children\":\"Application development. \"}],\"We have a team of skilled developers who are experts in the latest app frameworks, like Angular 1 and Google Web Toolkit.\"]}]}]}],[\"$\",\"li\",null,{\"className\":\"group mt-10 first:mt-0\",\"children\":[\"$\",\"$L9\",null,{\"children\":[\"$\",\"div\",null,{\"className\":\"pt-10 group-first:pt-0 group-first:before:hidden group-first:after:hidden relative before:absolute after:absolute before:bg-neutral-950 after:bg-neutral-950/10 before:left-0 before:top-0 before:h-px before:w-6 after:left-8 after:right-0 after:top-0 after:h-px\",\"children\":[[\"$\",\"strong\",null,{\"className\":\"font-semibold text-neutral-950\",\"children\":\"E-commerce. \"}],\"We are at the forefront of modern e-commerce development. Which mainly means adding your logo to the Shopify store template we’ve used for the past six years.\"]}]}]}],[\"$\",\"li\",null,{\"className\":\"group mt-10 first:mt-0\",\"children\":[\"$\",\"$L9\",null,{\"children\":[\"$\",\"div\",null,{\"className\":\"pt-10 group-first:pt-0 group-first:before:hidden group-first:after:hidden relative before:absolute after:absolute before:bg-neutral-950 after:bg-neutral-950/10 before:left-0 before:top-0 before:h-px before:w-6 after:left-8 after:right-0 after:top-0 after:h-px\",\"children\":[[\"$\",\"strong\",null,{\"className\":\"font-semibold text-neutral-950\",\"children\":\"Custom content management. \"}],\"At Studio we understand the importance of having a robust and customised CMS. That’s why we run all of our client projects out of a single, enormous Joomla instance.\"]}]}]}]]}]}]]}]}]}]],[\"$\",\"div\",null,{\"className\":\"mx-auto max-w-7xl px-6 lg:px-8 mt-24 sm:mt-32 lg:mt-40\",\"children\":[\"$\",\"div\",null,{\"className\":\"mx-auto max-w-2xl lg:max-w-none\",\"children\":[\"$\",\"$L9\",null,{\"className\":\"-mx-6 rounded-4xl bg-neutral-950 px-6 py-20 sm:mx-0 sm:py-32 md:px-12\",\"children\":[\"$\",\"div\",null,{\"className\":\"mx-auto max-w-4xl\",\"children\":[\"$\",\"div\",null,{\"className\":\"max-w-xl\",\"children\":[[\"$\",\"h2\",null,{\"className\":\"font-display text-3xl font-medium text-white [text-wrap:balance] sm:text-4xl\",\"children\":\"Tell us about your project\"}],[\"$\",\"div\",null,{\"className\":\"mt-6 flex\",\"children\":[\"$\",\"$La\",null,{\"className\":\"inline-flex rounded-full px-4 py-1.5 text-sm font-semibold transition bg-white text-neutral-950 hover:bg-neutral-200\",\"href\":\"/contact\",\"children\":[\"$\",\"span\",null,{\"className\":\"relative top-px\",\"children\":\"Say Hej\"}]}]}],[\"$\",\"div\",null,{\"className\":\"mt-10 border-t border-white/10 pt-10\",\"children\":[[\"$\",\"h3\",null,{\"className\":\"font-display text-base font-semibold text-white\",\"children\":\"Our offices\"}],[\"$\",\"ul\",null,{\"role\":\"list\",\"className\":\"mt-6 grid grid-cols-1 gap-8 sm:grid-cols-2\",\"children\":[[\"$\",\"li\",null,{\"children\":[\"$\",\"address\",null,{\"className\":\"text-sm not-italic text-neutral-300\",\"children\":[[\"$\",\"strong\",null,{\"className\":\"text-white\",\"children\":\"Copenhagen\"}],[\"$\",\"br\",null,{}],[\"1 Carlsberg Gate\",[\"$\",\"br\",null,{}],\"1260, København, Denmark\"]]}]}],[\"$\",\"li\",null,{\"children\":[\"$\",\"address\",null,{\"className\":\"text-sm not-italic text-neutral-300\",\"children\":[[\"$\",\"strong\",null,{\"className\":\"text-white\",\"children\":\"Billund\"}],[\"$\",\"br\",null,{}],[\"24 Lego Allé\",[\"$\",\"br\",null,{}],\"7190, Billund, Denmark\"]]}]}]]}]]}]]}]}]}]}]}]]\n"])</script>
